	...
	<form class="form-horizontal" action="#" method="post">
		...
		<fieldset> <legend>Dados</legend>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input id="nome" class="form-control" type="text" name="nome" /> <br>
				</div>
			</div>
			<div class="form-group">
				<label class="col-xs-2 control-label" for="email">Email:</label>
				<div class="col-sm-10">
					<input id="email" class="form-control" type="email" name="email" /> <br>
				</div>
			</div>
			<div class="form-group">
		...
		<fieldset> <legend>Mensagem</legend>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input id="assunto" class="form-control" type="text" name="assunto" /> <br>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="mensagem">Mensagem:</label>
				<div class="col-sm-10">
					<textarea id="mensagem" class="form-control" name="mensagem" rows="5"></textarea> <br>
				</div>
			</div>
		</fieldset>
